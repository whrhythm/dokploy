		...
		const manifest = JSON.stringify(
			{
				...
				name: `小智Ops-${format(new Date(), "yyyy-MM-dd")}-${randomString()}`,
				url: origin,
				hook_attributes: {
					...
					<CardContent className="p-0">
						<div className="flex flex-col ">
							<p className="text-muted-foreground text-sm">
								{t("settings.gitProviders.github.intro")}
							</p>
							<div className="mt-4 flex flex-col gap-4">
								...
								{isOrganization && (
									<Input
										required
										placeholder={t(
											"settings.gitProviders.github.organizationPlaceholder",
										)}
							...
							>
								...
								<div className="flex w-full items-center justify-between">
									...
									>
										{t("settings.gitProviders.github.unsure")}
									</a>
									<Button
										disabled={
