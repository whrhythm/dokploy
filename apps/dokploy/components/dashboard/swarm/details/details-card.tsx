...
export function NodeCard({ node, serverId }: Props) {
			...
			<Card className="w-full bg-background">
				<CardHeader>
					<CardTitle className="flex items-center justify-between text-lg">
						...
						<Badge variant="green">
							{node.ManagerStatus || t("swarm.worker")}
						</Badge>
					</CardTitle>
				</CardHeader>
				<CardContent>
	...
	return (
		<Card className="w-full bg-background">
			<CardHeader>
				<CardTitle className="text-lg">{t("swarm.nodeStatus")}</CardTitle>
			</CardHeader>
			<CardContent>
				<div className="space-y-6">
					<div className="flex flex-wrap gap-y-2 items-center justify-between">
						...
						<div className="flex flex-wrap items-center gap-4">
							<Badge variant="green">
								{t("swarm.tlsStatus")}: {node.TLSStatus}
							</Badge>
							<Badge variant="blue">
								{t("swarm.availability")}: {node.Availability}
							</Badge>
						</div>
					</div>
