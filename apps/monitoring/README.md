# 小智Ops Monitoring (Go Version)

Application that powers 小智Ops's monitoring service.
...
小智Ops uses a callback URL to send notifications when metrics exceed configured thresholds. Notifications are sent via POST request in the following format:
